        ...
        <div className="grid gap-8 mb-6 lg:mb-16 md:grid-cols-2">
          <div className="items-center  rounded-lg shadow sm:flex  ">
            ...
            <div className="p-5">
              ...
              <span className="text-lumiorange">CEO & Web Developer</span>
          ...
          <div className="items-center rounded-lg shadow sm:flex ">
            ...
            <div className="p-5">
              ...
              <span className="text-lumiorange">CTO</span>
              <p className="mt-3 mb-4 font-light ">
          ...
          <div className="items-center  rounded-lg shadow sm:flex ">
            ...
            <div className="p-5">
              ...
              <span className="text-lumiorange">
          ...
          <div className="items-center  rounded-lg shadow sm:flex ">
            ...
            <div className="p-5">
              ...
              <span className="text-lumiorange">Marketing & Sale</span>
              <p className="mt-3 mb-4 font-light ">
